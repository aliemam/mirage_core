...
printf "${GREEN}---------- I will now create your database and migrate data.sql ${NC} \n"
...
if [ "$RESULT" == ${db[4]} ]; then
  ...
  dbcreate=`mysql -h${db[1]} -u${db[2]} -p${db[3]} --skip-column-names -e "CREATE DATABASE ${db[4]} DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;"`
